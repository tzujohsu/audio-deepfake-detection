...
class ResNet18(Model):
    ...
    def __init__(self, inputs, num_classes, **kwargs):
        ...
        self.res_4_1 = ResnetBlock(64, down_sample=True)
        self.res_4_2 = ResnetBlock(64)
...
def build_resnet(shape: List[int], n_label: int = 2) -> tf.keras.Model:
  return ResNet18(inputs=input, num_classes=n_label)